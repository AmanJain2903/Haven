...
def delete_video(video_id: int, db: Session = Depends(get_db)):
    ...
    for album in albums:
        ...
        album.album_size -= vid.file_size
        # If this was the cover, clear it
        if album.album_cover_type == 'video' and album.album_cover_id == video_id:
            # Check if there are any other videos in the album
            if album.album_videos_count > 0:
    ...
    # 3. Delete original file from cold storage (storagePath/videos/)
